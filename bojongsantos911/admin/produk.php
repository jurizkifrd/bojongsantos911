...
<head>
    ...
    <title>Kelola Produk - SukaRental</title>
                        ...
                        <ul class="metismenu" id="menu">
							...
							<li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="produk.php">Motor</a></li>
										 ...
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											while($p=mysqli_fetch_array($brgs)){
												...
												<tr>
													...
													<td>
            											<!-- <a href="edit.php?idproduk=" class="btn btn-warning text-white">Edit</a> -->
            											<a href="delete.php?idproduk=<?php echo $p["idproduk"] ?>" class="btn btn-danger">Hapus</a>
          											</td>
